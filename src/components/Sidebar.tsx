...
import { Briefcase, GraduationCap, Trophy, Lightbulb, Mail, Menu, X, Linkedin } from 'lucide-react';
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-50 glass-effect border-b border-border">
        <div className="flex items-center justify-between px-5 py-4">
          <div>
            ...
            <p className="text-[11px] text-muted-foreground">Director of Quality Engineering</p>
          </div>
          <button
      ...
      <aside className="sidebar-nav">
        <div className="mb-14">
          ...
          <div className="mt-4 space-y-1">
            <p className="text-sm font-medium text-foreground">Director, Quality Engineering</p>
